package com.hhplus.concert.business.facade;
...
@SpringBootTest
@Transactional
public class SharedLockConcertFacadeTest {
    ...
    public void testSeatReservationWithConcurrency() throws InterruptedException {
        ...
        ConcertSeatDomain concertSeatDomain = new ConcertSeatDomain(
                seatId, concertId, concertOptionId, "A1", 100L, ReservationStatusType.WAIT, 0L
        );
